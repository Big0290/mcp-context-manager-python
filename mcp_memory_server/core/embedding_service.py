...
class EmbeddingService:
        ...
        try:
            if settings.embedding_model == "openai":
                ...
                try:
                    ...
                    print("Warning: sentence-transformers not available, using fallback model")
    ...
    async def _batch_generate_openai_embeddings(self, texts: List[str]) -> List[List[float]]:
    ...
    async def _batch_generate_sentence_transformer_embeddings(self, texts: List[str]) -> List[List[float]]:
