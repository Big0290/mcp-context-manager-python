...
class AgentService:
    ...
    async def create_agent(self, db: Session, agent_data: AgentCreate) -> AgentResponse:
        """Create a new agent."""
    ...
    async def get_agent(self, db: Session, agent_id: UUID) -> Optional[AgentResponse]:
        """Get agent by ID."""
        agent = (
            db.query(Agent)
    ...
    async def update_agent(
        self, db: Session, agent_id: UUID, update_data: AgentUpdate
    ...
    async def ping_agent(self, db: Session, agent_id: UUID) -> bool:
    ...
    async def deactivate_agent(self, db: Session, agent_id: UUID) -> bool:
