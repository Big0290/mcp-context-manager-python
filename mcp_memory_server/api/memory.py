...
async def get_recent_memories(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get recent memories: {str(e)}"
        )
...
async def get_project_memories(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get project memories: {str(e)}"
        )
...
async def summarize_agent_memories(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to summarize memories: {str(e)}"
        )
