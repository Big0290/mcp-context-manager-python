...
def migrate_memories():
    ...
    try:
        ...
        source_cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='memories'")
        ...
        for memory in memories:
            ...
            target_cursor.execute('''
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?)
            ''', (content, memory_type, priority, tags, project_id, 'cursor-agent', created_at))
