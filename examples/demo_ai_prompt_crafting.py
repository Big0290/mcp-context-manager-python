...
• [LOW] [AI_RESPONSE] AI provided response: No previous context found for this project. Starting fresh conversation.
  Tags: mcp"""
    ...
    for i, scenario in enumerate(scenarios, 1):
        ...
        # Craft the AI prompt
        crafted_prompt = await crafter.craft_ai_prompt(context, scenario["user_message"])
    ...
    analysis = crafter._analyze_context(context_summary, "Help me implement a new feature")
