...
async def example_similar_experience_search():
    ...
    result = await server.execute_tool("search_similar_experiences", {
        "query": search_query,
        "project_id": "react-project",
...
async def example_knowledge_graph():
    ...
    result = await server.execute_tool("get_knowledge_graph", {
...
async def example_memory_insights():
    ...
    # Get memory insights
    result = await server.execute_tool("get_memory_insights", {
        "project_id": "react-project",
...
async def example_knowledge_path_tracing():
    ...
    result = await server.execute_tool("trace_knowledge_path", {
...
async def example_memory_promotion():
    ...
    fetch_result = await server.execute_tool("fetch_memory", {
        "query": "React",
        "project_id": "react-project",
        "limit": 3
    })
    ...
    # Promote memories
    result = await server.execute_tool("promote_memory_knowledge", {
...
async def example_enhanced_context_injection():
    ...
    result = await server.execute_tool("get_context_summary", {
        "project_id": "react-project",
        "max_memories": 10,
        "include_recent": True,
