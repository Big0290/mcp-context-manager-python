...
def simulate_chat_session_start(
    process: subprocess.Popen, project_id: str = "cursor-chat"
):
    ...
    if "project cleanup" in context_summary.lower():
        ...
        print(
            "• The project structure has been cleaned up and is now developer-friendly"
        )
        print(
            "• We've implemented stdin/stdout communication following MCP specifications"
        )
    ...
    try:
        ...
        init_message = {
            ...
            "params": {
                ...
                "capabilities": {},
                "clientInfo": {"name": "context-injection-demo", "version": "0.1.0"},
            },
        }
