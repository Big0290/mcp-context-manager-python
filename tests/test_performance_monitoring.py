    ...
    try:
        ...
        init_message = {
            ...
            "params": {
                ...
                "capabilities": {},
                "clientInfo": {"name": "performance-test", "version": "0.1.0"},
            },
        }
        ...
        for i in range(3):
            ...
            print(
                f"✅ Memory {i+1} added: {result.get('content', [{}])[0].get('text', '')}"
            )
        ...
        context_message = {
            ...
            "params": {
                ...
                "arguments": {"project_id": "performance-test", "max_memories": 5},
            },
        }
        ...
        report_message = {
            ...
            "params": {
                ...
                "arguments": {"days": 1, "include_recommendations": True},
            },
        }
