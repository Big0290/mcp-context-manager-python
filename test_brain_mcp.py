...
async def test_brain_server():
    ...
    try:
        ...
        brain_tools = [t for t in tools if "brain" in t.get("description", "").lower() 
        ...
        result = await server.execute_tool("push_memory", {
        ...
        search_result = await server.execute_tool("search_similar_experiences", {
